...
from PySide6.QtWidgets import (
    ...
    QSpacerItem, QSizePolicy, QTabWidget, QInputDialog, QTextEdit
)
from components.lcm_msg.lcm_std import Float32MultiArray
...
class DynamicContent(QWidget):
    def __init__(self):
        ...
        self.type_box.addItems(["Float32MultiArray", "Twist", "Vec3", "Pose", "String", "JointState"])
